...
if (ctx) {
    const numberGlyph = new (0, _glyph.Glyph)(ctx, canvas.clientHeight, canvas.clientWidth, {
        x: 0,
        y: 0
    }, {
...
},{"./glyph":"f4QfP"}],"f4QfP":[function(require,module,exports,__globalThis) {
...
class Glyph {
    ...
    set number(value) {
        ...
        this.digitsArray = (0, _helpersDefault.default).splitStringIntoDigits(this.number);
        ...
        this.consecutiveNumbers = (0, _helpersDefault.default).getConsecutiveNumbers(this.digitsArray);
    }
    get number() {
        return this._digit;
    }
    draw() {
        ...
        (0, _helpersDefault.default).generateArrayWithDifferentAdjacentDigits(this.digitsArray).forEach((digit, index)=>{
        ...
        this.digitsArray.forEach((digit, index)=>{
            if (index !== 0 && (0, _helpersDefault.default).isSameDirection(this.digitsDirections[index], this.digitsDirections[index - 1]) && digit !== this.digitsArray[index - 1]) {
                const coordinates = this.getNumberCoordinate(digit);
                const nextCoordinates = this.getNumberCoordinate(this.digitsArray[index + 1]);
                const normalizedPerpendicularVector = (0, _helpersDefault.default).getNormalizedVectorFromCoordinates(coordinates, nextCoordinates);
                this.ctx.beginPath();
    ...
    getNumberCoordinate(num) {
        const yIndex = (0, _helpersDefault.default).lerp(num, 1, 9, 8, 0);
        if (num === 0) return {
    ...
    getStartCircleCoordinates() {
        ...
        const secondCoord = this.digitsCoordinates.find((coord)=>{
            return !(0, _helpersDefault.default).areCoordinatesEqual(firstCoord, coord);
        }) ?? this.digitsCoordinates[1];
        const vector = (0, _helpersDefault.default).normalizeVector((0, _helpersDefault.default).getVector(firstCoord, secondCoord));
        return {
...
},{"./helpers":"ix8tX","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"ix8tX":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "lerp", ()=>lerp);
parcelHelpers.export(exports, "splitNumberIntoDigits", ()=>splitNumberIntoDigits);
parcelHelpers.export(exports, "splitStringIntoDigits", ()=>splitStringIntoDigits);
parcelHelpers.export(exports, "isSameDirection", ()=>isSameDirection);
parcelHelpers.export(exports, "isOppositiveDirection", ()=>isOppositiveDirection);
parcelHelpers.export(exports, "generateArrayWithDifferentAdjacentDigits", ()=>generateArrayWithDifferentAdjacentDigits);
parcelHelpers.export(exports, "getConsecutiveNumbers", ()=>getConsecutiveNumbers);
parcelHelpers.export(exports, "getPerpendicularDirection", ()=>getPerpendicularDirection);
parcelHelpers.export(exports, "getVector", ()=>getVector);
parcelHelpers.export(exports, "getPerpendicularVector", ()=>getPerpendicularVector);
parcelHelpers.export(exports, "normalizeVector", ()=>normalizeVector);
parcelHelpers.export(exports, "getNormalizedVectorFromCoordinates", ()=>getNormalizedVectorFromCoordinates);
parcelHelpers.export(exports, "areCoordinatesEqual", ()=>areCoordinatesEqual);
...
function splitStringIntoDigits(n) {
    return Array.from(n, Number);
}
function isSameDirection(dir, dirToCompare) {
    return dir.x === dirToCompare.x && dir.y === dirToCompare.y;
}
function isOppositiveDirection(dir, dirToCompare) {
    return dir.x * -1 === dirToCompare.x && dir.y * -1 === dirToCompare.y;
}
function generateArrayWithDifferentAdjacentDigits(arr) {
    let result = [
        arr[0]
    ];
...
function getConsecutiveNumbers(arr) {
    const result = [];
...
function getVector(coord1, coord2) {
    return {
        x: coord2.x - coord1.x,
        y: coord2.y - coord1.y
    };
...
function getNormalizedVectorFromCoordinates(coord1, coord2) {
...
},{}]},["eZFTg","9Fk10"], "9Fk10", "parcelRequire8661", {})

//# sourceMappingURL=number-glyph.c9112ede.js.map
